...
- **R2 Storage**: FUSE-mounted at `/home/user` for persistent files
...
Your terminal runs inside tmux:
...
cloudshell/
├── src/
│   ├── index.ts       # Worker entry, routes, container proxy
...
├── startup.sh          # R2 FUSE mount script
